...
package nijanus.customerDesktop.phpAndMySQL.imagesNamesSelector
{
	...
	// Класс выборщика артикулов изображений, отфильтрованных по категоиям,
	// из таблиц MySQL.
	public class MySQLImagesArticlesFilteredByCategoriesSelector
		extends MySQLDataSelector
	{
		...
		public static const CLASS_NAME: String =
			"MySQLImagesArticlesFilteredByCategoriesSelector";	
		//-----------------------------------------------------------------------			
		...
		public var GoodsCategoriesCodesColumnName: String = null;
		// Значение кода категории товара - значение фильтра.
		public var GoodCategoryCodeValue:          Object = null;		
		...
		// Метод-конструктор экземпляра выборщика артикулов изображений,
		...
		public function MySQLImagesArticlesFilteredByCategoriesSelector
		(
		...
		): void
		{
			...
			this._MainTracer.CreateClassNewInstance
				( MySQLImagesArticlesFilteredByCategoriesSelector.CLASS_NAME,
		...
		override public function get RequestPHPFileURLVariables( ): URLVariables
		{
			...
			// Имя столбца кодов в таблице категорий товаров -
			// имя фильтрующего столбца.
			requestPHPFileURLVariables.GoodsCategoriesCodesColumnName =
				this.GoodsCategoriesCodesColumnName; 
			// Значение кода категории товара - значение фильтра.
			requestPHPFileURLVariables.GoodCategoryCodeValue          =
				this.GoodCategoryCodeValue;
