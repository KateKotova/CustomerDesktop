...
package nijanus.customerDesktop.phpAndMySQL.diskNotesSelector
{
	...
	// Класс выборщика примечаний второго типа диска из таблиц MySQL.
	public class MySQLDiskSecondTypeNotesSelector extends MySQLDataSelector
	{
		// Список импортированных классов из других пакетов.
		...
		public static const CLASS_NAME: String =
			"MySQLDiskSecondTypeNotesSelector";	
		//-----------------------------------------------------------------------	
		...
		// Метод-конструктор экземпляра выборщика примечаний второго типа диска
		// из таблиц MySQL.
		// Параметры:
		...
		public function MySQLDiskSecondTypeNotesSelector
		(
		...
		): void
		{
			...
			this._MainTracer.CreateClassNewInstance
				( MySQLDiskSecondTypeNotesSelector.CLASS_NAME,
		...
		override public function get RequestArrayResult( ): Array
		{
			...
			this._MainTracer.SetClassPropertie
				( MySQLDiskSecondTypeNotesSelector.CLASS_NAME, "RequestArrayResult",
				requestArrayResult );					
