...
{
	// Класс серого полупрозрачного спрайта.
	public class TranslucentGraySprite extends TranslucentGraySpriteBase
	{
		...
		// Метод-конструктор экземпляра серого полупрозрачного спрайта.
		public function TranslucentGraySprite( ): void
		{
			// Вызов метода-конструктора суперкласса TranslucentGraySpriteBase.
			super( );
		} // TranslucentGraySprite
		//-----------------------------------------------------------------------
		// Get- и set-методы.		
		...
		public function get Bounds( ): RectangleWithPerimeterBorder
		{
			...
			// серого полупрозрачного спрайта, с теневым бордюром.
		...
		public function get BoundsWithoutBorder( ): Rectangle
		{
			...
			// соответствующего границам серого полупрозрачного спрайта.
