...
namespace SkinEngine
{
    class SK
    {
        ...
        public static Bitmap GetResourceBitmap(string ResourceName)
        {
            ...
            switch (ResourceName)
            {
                case "ButtonExit":        // Котова
                case "ButtonFullScreen":  // Котова
                case "ButtonSmallScreen": // Котова
                case "ButtonSound":       // Котова
                case "ButtonPlay":        // Котова
                case "ButtonPause":       // Котова
                case "ButtonMuteOn":      // Котова
                case "ButtonMuteOff":     // Котова
