<?php
	// Скрипт, возвращающий артикулы изображений.
	...
	$parFilteringColumnName = $_GET[ 'FilteringColumnName' ];
	// Значение фильтра.
	$parFilterValue         = $_GET[ 'FilterValue' ];
	...
	$mySQLQueryString =
		...
		"WHERE " .
			...
			"{$parNomenclaturesTableName}.{$parFilteringColumnName} = " .
				"{$parFilterValue} " .
