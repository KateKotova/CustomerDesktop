<?php
	// Скрипт, возвращающий текстовые метки кнопок меню.
	...
	$parMenuButtonsTableName        = $_GET[ 'MenuButtonsTableName' ];
	// Имя столбца текстовых меток кнопок меню.
	$parMenuButtonsLablesColumnName = $_GET[ 'MenuButtonsLablesColumnName' ];
	...
	$mySQLQueryString =
		"SELECT {$parMenuButtonsLablesColumnName} " .
		"FROM {$parMenuButtonsTableName} " .
		"ORDER BY {$parOrderingColumnName} ";
	// Если направление упорядочения истинно, то текстовые метки кнопок меню
...
*/
	...
	// XML-дерево.
	// Корневой элемент XML-дерева - таблица кнопок меню - открывающий тег.
	$xmlTree = "<{$parMenuButtonsTableName}>\n";
	...
	while ( $mySQLQueryFetch = mysql_fetch_assoc( $mySQLQueryID ) )
	{
		...
		$xmlTree .= "\t<Row>\n";
		// Элемент XML-дерева - столбец текстовых меток кнопок меню.
		$xmlTree .=
			"\t\t<{$parMenuButtonsLablesColumnName}>" .
			$mySQLQueryFetch[ $parMenuButtonsLablesColumnName ] .
			"</{$parMenuButtonsLablesColumnName}>\n";
		// Элемент XML-дерева - строка - закрывающий тег.
		$xmlTree .= "\t</Row>\n";
	} // while

	// Корневой элемент XML-дерева - таблица кнопок меню - закрывающий тег.
	$xmlTree .= "</{$parMenuButtonsTableName}>";
